...
public class Order extends BaseEntity implements Serializable {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(getOid(), getUid(), getRecvName(), getRecvPhone(), getRecvProvince(), getRecvCity(), getRecvArea(), getRecvAddress(), getTotalPrice(), getStatus(), getOrderTime(), getPayTime());
    }
